...
struct OnboardingView: View {
    ...
    private let pages: [(icon: String, title: String, desc: String, color: Color)] = [
        ("eye.circle.fill", "Eye Focus Timer", "Build healthy screen habits with the 20-20-20 rule, recommended by the American Academy of Ophthalmology. Every 20 minutes, take a 20-second break and look at something 20 feet away.", Theme.cyan),
        ...
        ("figure.mind.and.body", "Eye Exercises", "Six interactive exercises based on optometric guidelines (AAO, AOA). Follow dots, shift focus, practice blinking, and train peripheral awareness.", Theme.mint),
        ("chart.bar.fill", "Track Progress", "Monitor your habit score, daily streaks, breaks taken, and exercises completed. Build consistent screen wellness habits with visual progress tracking.", Theme.amber)
    ]
